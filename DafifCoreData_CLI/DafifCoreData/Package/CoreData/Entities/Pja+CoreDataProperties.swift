...
extension Pja {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<Pja> {
        return NSFetchRequest<Pja>(entityName: "Pja")
    }
    ...
    @NSManaged public var distance1: NSDecimalNumber?
    @NSManaged public var distance2: NSDecimalNumber?
